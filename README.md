<p align="center">
  <img src="assets/header.svg" alt="douyin-底层算法逻辑分享" width="100%">
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Douyin-Recommendation_Algorithm-0F172A?style=for-the-badge" alt="Douyin Recommendation Algorithm">
  <img src="https://img.shields.io/badge/E--commerce-User_Journey-2563EB?style=for-the-badge" alt="E-commerce User Journey">
  <img src="https://img.shields.io/badge/Language-Chinese-7C3AED?style=for-the-badge" alt="Language Chinese">
</p>

<p align="center">
  <a href="#story">沉浸式故事</a> ·
  <a href="#algorithm">算法与人性</a> ·
  <a href="#visuals">核心图解</a> ·
  <a href="#source">来源说明</a>
</p>

> 从“只刷五分钟”到28分钟后完成支付：这不是一份抽象的算法公式，而是一次普通用户如何被内容留住、被痛点击中、在直播间建立信任并最终下单的完整模拟。
...
| 用户视角 | 算法视角 | 商业视角 |
|---|---|---|
| “我只是随便看看” | 每次停留、划走与点击都在形成反馈 | 内容首先争夺注意力 |
| “她和我身材差不多” | 系统预测下一次行为，而非真正读心 | 具体身份帮助用户对号入座 |
| “先买回来试试” | 支付让内容—直播—商品链路闭环 | 信任、优惠与售后共同消除阻力 |

适合电商运营、直播从业者、内容创作者，以及希望从用户视角理解推荐系统的人阅读。

---

<a id="story"></a>

## 正文：重生之我是27岁的梨形身材上班族，如何在抖音完成一次下单
...
原始内容来自[飞书文档](https://my.feishu.cn/docx/QtwWdtt7aoQ3O2xKPKWcyhiZnXf)，详细来源信息见 [SOURCE.md](SOURCE.md)。
